...
public interface IAutoRepairRepository : IGetAllAsync<AutoRepair>, IAddAsync<AutoRepair>, IGetByNameAsync<AutoRepair> , IGetByIdAsync<AutoRepair>, IDeleteAsync<AutoRepair> {
